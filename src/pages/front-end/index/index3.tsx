            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-6 border">
                ...
                <div className={`py-12 flex flex-col md:flex-row items-center md:items-start gap-8 transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
                    <div className="w-full">
                        ...
                        <h1 className="text-2xl md:text-4xl font-extrabold leading-tight text-gray-900 dark:text-white">简洁、高效的开发者 API 平台</h1>
                        <p className="mt-4 text-gray-700 dark:text-gray-300 text-lg">统一接口、清晰文档、稳定可靠。分钟级完成接入，轻松为你的应用提供数据与服务。</p>
                        <div className="mt-6 flex gap-4">
                            <Button size="large" type="primary" onClick={goHome}>立即体验</Button>
                            <a href="https://www.baidu.com" target="_blank" rel="noreferrer" className="inline-flex items-center rounded-md border border-gray-300 dark:border-gray-600 px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">查看文档</a>
                        </div>
                ...
                <div className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-4" id="features">
                            {features.map((feature, index) => {
                                ...
                                return (
                                    <div key={index} className="p-4 flex items-center gap-2 rounded-xl bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:-translate-y-1">
                                        <Icon className="text-primary-500 mx-4" />
                                <div>
                                <div className="my-2 font-semibold text-gray-900 dark:text-white">{feature.title}</div>
                ...
                <div className="mt-12 py-12" id="pricing">
                    <div className="text-center">
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">按需使用，透明价格</div>
                        <div className="mt-2 text-gray-600 dark:text-gray-400">免费额度适合开发与测试，生产可随时升级。</div>
                    </div>
                    <div className="mt-6 grid md:grid-cols-3 gap-6">
                        <div className="p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm transition-transform duration-300 hover:-translate-y-1">
                            <div className="font-bold text-xl text-gray-900 dark:text-white">免费版</div>
                            <div className="text-3xl mt-2 text-gray-900 dark:text-white">¥0</div>
                            <ul className="mt-3 text-gray-600 dark:text-gray-400 text-sm space-y-2">
                                <li>基础接口访问</li>
                                <li>速率限制较低</li>
                                <li>社区支持</li>
                            </ul>
