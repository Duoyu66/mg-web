    ...
    const [records, setRecords] = useState<Record[]>([
        ...
        },
        {
            ...
            "bestComment": {
                ...
                "plainTextDescription": "连续三天坚持学习计划真不容易！看到你覆盖了这么多领域，这种多元化的努力特别值得点赞，继续突破自己吧！",
                "user": {
        ...
        },
        {
            ...
            "bestComment": {
                ...
                "plainTextDescription": "坚持306天打卡真的超有毅力！400单词+设计模式练习已经很棒了，深浅拷贝的问题明天一定能突破~",
                "user": {
                    "id": "1983770924322050049",
                    "userName": "加油鸭"
                }
        ...
        },
        {
            ...
            "bestComment": {
                ...
                "plainTextDescription": "40天的坚持太棒了！每天进步一点点，技术、健康和面试准备都在稳步推进，为你点赞！",
                "user": {
                    "id": "1983770924322050049",
                    "userName": "加油鸭"
                }
        ...
        },
        {
            ...
            "bestComment": {
                ...
                "plainTextDescription": "坚持刷题第8天啦！看到你攻克了这么多经典题目，还认真复习Java知识，这份自律真的很棒。继续保持这种节奏，进步会越来越明显！",
                "user": {
                    "id": "1983770924322050049",
                    "userName": "加油鸭"
                }
        ...
        },
        {
            ...
            "bestComment": {
                ...
                "plainTextDescription": "每天坚持学习这么多干货真不容易！你对知识的分类和思考很深刻，这种持续积累的态度一定会带来质的飞跃~",
                "user": {
                    "id": "1983770924322050049",
                    "userName": "加油鸭"
                }
                ...
                <div className="flex gap-6">
                    ...
                    <div className="w-80 flex-shrink-0 space-y-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">热门话题</h3>
                            <div className="space-y-2">
                                {['学习打卡', '训练营打卡', 'Java后端', '算法刷题', '求职面试'].map((topic, index) => (
                                    <div 
                                        key={index}
                        ...
                        {/* 推荐用户 */}
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">推荐关注</h3>
                        ...
                        {/* 统计信息 */}
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">社区数据</h3>
