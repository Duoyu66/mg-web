      ...
      <div className={styles["content"]}>
        <div className={styles["topScoreStyle"]}>
          ...
          <div className={styles["tipStyle"]}>
            <InfoCircleOutlined />
            您本次成绩在本站超越了{result.ranking}%的小伙伴~
          </div>
        </div>
          ...
          <li className={styles["contentLi"]}>
            ...
            <div className={styles["liRight"]}>
              <div className={styles["topStyle"]}>
                <span className={styles["rateStyle"]}>
                  {" "}
                  {((result.acNum / result.allNum) * 100).toFixed(2)}
                </span>
                <span className={styles["rateStyleLittle"]}>%</span>
              </div>
              <div className={styles["bottomStyle"]}>正确率</div>
            </div>
          </li>
          <li className={styles["contentLi"]}>
            <div className={styles["liLeft"]}>
            ...
            <div className={styles["liRight"]}>
              <div className={styles["topStyle"]}>
                ...
                <span className={styles["rateStyleLittle"]}>
                  / {result.allNum}
                </span>
              </div>
              <div className={styles["bottomStyle"]}>答对题目数</div>
            </div>
          </li>
          ...
          <li className={styles["contentLi"]}>
            ...
            <div className={styles["liRight"]}>
              <div className={styles["topStyle"]}>
                ...
                <span className={styles["rateStyle"]}>
                  {" "}
                  {formatTime(result.time)[1]}{" "}
                </span>
                <span className={styles["rateStyleLittle"]}> 秒</span>
              </div>
              <div className={styles["bottomStyle"]}>本次用时</div>
            </div>
          </li>
        </ul>
        ...
        >
          ...
          <span
            onClick={() => nav("/question/questionHome")}
