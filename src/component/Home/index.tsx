...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white p-4 transition-colors duration-300">
            我是Home组件
            {/* --- {JSON.stringify(data)} */}
            <ul className="space-y-2">
                {acList &&
                    acList.length > 0 &&
                    acList.map((m: AcItem) => {
                        return <li key={m.id} className="p-2 bg-gray-100 dark:bg-gray-800 rounded transition-colors duration-300">{m.name}</li>;
                    })}
            </ul>
            {
            ...
            <div className="w-[200px] h-[200px] border border-gray-300 dark:border-gray-600 bg-primary-500 dark:bg-primary-700 mt-4 transition-colors duration-300">
